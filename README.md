...
Maybe my code and my description are bad, your comments, advices, suggetions, edits，optimizations are sincerely wanted. Just feel free to make any comments, advices, suggetions, edits，optimizations or any other things you want to everything of this repository even to me. All of these are certainly supper great help to me and my repository.
...
也许我的代码和我的描述都很不完善， 我真心地期待你的评价、意见、建议、修改、优化。尽管对我的项目做任何评价、意见、建议、修改、优化或者提出其他的想法，所有的这些肯定都会成为巨大的帮助。
